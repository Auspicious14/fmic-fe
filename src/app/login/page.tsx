    ...
    <div className="flex flex-col items-center justify-center min-h-screen px-6 bg-slate-50">
      <div className="w-full max-w-sm">
        <div className="mb-10 text-center">
          <h1 className="text-3xl font-black text-slate-900 tracking-tight">FMIC</h1>
          <p className="text-slate-500 font-medium mt-2">Financial Memory for Shop Owners</p>
        </div>
        ...
        <p className="text-center mt-8 text-sm text-slate-400 font-medium">
          Don't have an account? <span className="text-slate-900 font-bold cursor-pointer" onClick={() => router.push('/register')}>Register your shop</span>
        </p>
      </div>
    </div>
  );
